			...
			<div class="col">
				...
				<form action="petugas-update.php" method="post">
					...
					<div class="input-group mb-1 input-sm">
						...
						<input type="text" name="nama_petugas" class="form-control" required autofocus autocomplete="off" value="<?= $data['nama_petugas'];?>">
					</div>

					<div class="input-group mb-1">
						<span class="input-group-text lebar" >Username</span>
						<input  type="text" name="username" class="form-control" required autocomplete="off" value="<?= $data['username'];?>">
					</div>
