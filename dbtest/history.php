...
<body onload="window.print()">
	...
	<table border="1" width="100%">
		...
		if($level=="siswa"){
			$nisn = $_SESSION['nisn'];
			$sql = "SELECT * FROM tbl_pembayaran a INNER JOIN tb_siswa b ON a.nisn=b.nisn INNER JOIN tbl_kelas c ON b.id_kelas=c.id_kelas INNER JOIN tbl_spp d ON a.id_spp=d.idspp INNER JOIN tbl_petugas e ON a.id_petugas=e.id_petugas WHERE a.nisn='$nisn' ORDER BY a.tgl_bayar";
		}else{
			$sql = "SELECT * FROM tbl_pembayaran a INNER JOIN tb_siswa b ON a.nisn=b.nisn INNER JOIN tbl_kelas c ON b.id_kelas=c.id_kelas INNER JOIN tbl_spp d ON a.id_spp=d.idspp INNER JOIN tbl_petugas e ON a.id_petugas=e.id_petugas ORDER BY a.tgl_bayar";
		}
